    ...
    <form id="form1" runat="server" action="WebForm1.aspx">
        ...
        <div class="form-group">
            ...
            <asp:CompareValidator ID="cvDate1" runat="server" Operator="LessThan" ControlToValidate="arrDate"
                ControlToCompare="depDate" CssClass="text-danger" ErrorMessage="Invalid date selected.">
            </asp:CompareValidator>
            <asp:TextBox ID="arrDate" runat="server" CssClass="form-control" type="date"></asp:TextBox>
            ...
            <asp:CompareValidator ID="cvDate2" runat="server" Operator="GreaterThan" Type="Date" ControlToValidate="depDate"
                ControlToCompare="arrDate" CssClass="text-danger" ErrorMessage=" Invalid date selected.">
            </asp:CompareValidator>
            <asp:TextBox ID="depDate" runat="server" CssClass="form-control" type="date"></asp:TextBox>
        </div>
        ...
        <div class="form-check form-check-inline"><!--radio group-->
        ...
        <div class="form-group.required .control-label:after">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" CssClass="validator" ControlToValidate="email"
            ...
            <asp:TextBox ID="email" runat="server" CssClass="form-control" required="true" type="email" />
        </div>

        <div class="form-group.required .control-label:after">
            <label for="phone">Phone</label>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="validator" ControlToValidate="phone"
            ...
            <asp:TextBox ID="phone" runat="server" CssClass="form-control" required="true" type="tel" />
        </div>
        ...
        <asp:Button ID="Button1" class="btn btn-primary" runat="server" type="submit" Text="Submit" OnClick="Button1_Click" />
